...
/**
 * Models an keyword entity field. A Entity field with a type {@code
 * EntityField.Type.K}
 *
 * @author Cristina González
 * @review
 */
public class KeywordEntityField extends EntityField {
	 ...
	 * @review
	 */
	public KeywordEntityField(
		String name,
		Function<Locale, String> filterableAndSortableFieldNameFunction) {

		super(
			name, Type.KEYWORD, filterableAndSortableFieldNameFunction,
